...
const createMockTaskRegistry = () => ({
  ...
  getTaskNode: jest.fn().mockResolvedValue(null),
  createTaskNode: jest.fn().mockResolvedValue({
    id: "node-s-1",
    threadId: "thread-1",
    parentNodeId: null,
    kind: "execution",
  ...
  createTaskClaim: jest.fn().mockResolvedValue(undefined),
  findActiveTaskClaim: jest.fn().mockResolvedValue(null),
  updateTaskClaim: jest.fn().mockResolvedValue(undefined),
  appendTaskMailboxMessage: jest.fn().mockResolvedValue(undefined),
  createTaskDependency: jest.fn().mockResolvedValue(undefined),
  createTaskVerifierJob: jest.fn().mockResolvedValue(undefined),
